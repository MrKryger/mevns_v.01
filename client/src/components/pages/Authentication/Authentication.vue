    ...
    <div class="l-auth-container">
        <div class="l-auth" v-if="!signUpVisible">
            <v-form v-model="validLogin">
                ...
                <v-btn block flat color="light-blue lighten-1" @click.native="signUpVisible = !signUpVisible">Create
                    account
                </v-btn>
        ...
        <div class="l-signup" v-else>
            <v-form v-model="validSignUp">
                ...
                <v-btn block flat color="light-blue lighten-1" @click.native="signUpVisible = !signUpVisible">Back
                </v-btn>
...
<style lang="scss">
    ...
    .l-auth {
        ...
        label, input, .icon {
            color: #05CBE1 !important;
        }

        .input-group__details {
            &:before {
                background-color: #FC2525 !important;
            }
        }
    }
